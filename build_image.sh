...
case "$ST" in
  ...
  PharoCore-1.0|PharoCore-1.1|PharoCore-1.2|PharoCore-1.3|Pharo-1.4|Pharo-2.0|Pharo-3.0|Squeak-4.3|Squeak4.3|Squeak-4.4|Squeak-4.5|Squeak-4.6|Squeak-Trunk)
